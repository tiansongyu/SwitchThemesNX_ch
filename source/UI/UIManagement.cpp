...
bool ImguiInit()
{
	...
	//font25 = io.Fonts->AddFontFromFileTTF(ASSET("opensans.ttf"), 30.0f,NULL, io.Fonts->GetGlyphRangesChineseSimplifiedCommon());
	//font30 = io.Fonts->AddFontFromFileTTF(ASSET("opensans.ttf"), 35.0f,NULL, io.Fonts->GetGlyphRangesChineseSimplifiedCommon());
	font40 = io.Fonts->AddFontFromFileTTF(ASSET("opensans.ttf"), 35.0f,NULL, io.Fonts->GetGlyphRangesChineseSimplifiedCommon());
	font30 = font40;
	font25 = font40;
...
bool UIMNG::InitUI()
{
	...
	mainWindow = glfwCreateWindow(SCR_W, SCR_H, "主题安装工具", nullptr, nullptr);
	if (!mainWindow)
	{
